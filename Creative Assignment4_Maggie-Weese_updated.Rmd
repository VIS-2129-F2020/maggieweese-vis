...
BPP_libraries is data on public pools in Baltimore sourched from the Baltimore City Data Directory
```{r}
...
This code allows me to search for streets in Baltimore, MD in Open Trip Planner and save it onto my desktop.
```{r}
...
In this section, I shift the projection to be the Baltimore City projection found on the site Spatial Reference. 
```{r}
