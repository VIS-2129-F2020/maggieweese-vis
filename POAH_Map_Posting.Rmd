...
CCBHC$describe2 <- paste("<b>",  
         "<p style='color:Black;'>", "<p style='font-size:16px;color:Black;'>", CCBHC$CCBHC_Name, "</b>", 
...
FQHC$describe3 <- paste("<b>",  
         "<p style='color:Black;'>", "<p style='font-size:16px;color:Black;'>", FQHC$F_Satellite_Name, "</b>", 
        "<b>", "<p style='color:Black;'>", " Address:", "</b>", FQHC$F_Place_addr,
        "<b>", "<p style='color:Black;'>", "Site Type:","</b>", FQHC$F_Site_Type, 
        "<b>", "<p style='color:Black;'>", "Phone Number:","</b>", FQHC$F_Telephone) %>%
  lapply(htmltools::HTML)
